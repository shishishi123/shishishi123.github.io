...
---
## 2024
- **Shanghao Shi**, Ning Wang, Yang Xiao, Chaoyu Zhang, Yi Shi, Y. Thomas Hou, and Wenjing Lou. "Scale-MIA: A Scalable Model Inversion Attack against Secure Federated Learning via Latent Space Reconstruction". In the Network and Distributed System Security Symposium 2025 (NDSS 25). [[PDF]](https://arxiv.org/pdf/2311.05808)
- Chaoyu Zhang, **Shanghao Shi**, Ning Wang, Xiangxiang Xu, Shaoyu Li, Lizhong Zheng, Randy Marchany, Mark Gardner, Y. Thomas Hou, Wenjing Lou. "Hermes: Boosting the Performance of Machine-Learning-Based Intrusion Detection System through Geometric Feature Learning". In the 25th International Symposium on Theory, Algorithmic Foundations, and Protocol Design for Mobile Networks and Mobile Computing (MobiHoc 24). Association for Computing Machinery, New York, NY, USA, 251–260. https://doi.org/10.1145/3641512.3686380. [[PDF]](http://shishishi123.github.io/files/hermes.pdf)
...
## Before
- Yang Xiao, **Shanghao Shi**, Wenjing Lou, Chonggang Wang, Xu Li, Ning Zhang, Y. Thomas Hou, and Jeffrey H. Reed. "Decentralized spectrum access system: Vision, challenges, and a blockchain solution." IEEE Wireless Communications 29, no. 1 (WCM 2022): 220-228. [[PDF]](http://shishishi123.github.io/files/decensas.pdf)
- **Shanghao Shi**, Yang Xiao, Wenjing Lou, Chonggang Wang, Xu Li, Y. Thomas Hou, and Jeffrey H. Reed. "Challenges and new directions in securing spectrum access systems." IEEE Internet of Things Journal 8, no. 8 (IoT-J 2021): 6498-6518. [[PDF]](http://shishishi123.github.io/files/spectrumsurvey.pdf)
