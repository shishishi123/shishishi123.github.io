...
redirect_from: 
  ...
  - /about.html
---
I am a postdoctoral research associate in the Department of Computer Science and Engineering at Washington University in St. Louis (WashU), working with [Prof. Ning Zhang](https://engineering.washu.edu/faculty/Ning-Zhang.html). I received my Ph.D. in Computer Science from Virginia Tech in 2025, advised by [Prof. Wenjing Lou](https://www.cnsr.ictas.vt.edu/WJLou.html) and [Prof. Yi Shi](https://sites.google.com/a/vt.edu/yi-shi/home). My research focuses on network security and information privacy, particularly machine learning security and privacy, wireless security, and CPS/IoT security.
...
- Our paper 'BoBa: Boosting Backdoor Detection through Data Distribution Inference in Federated Learning' was accepted by the 28th European Conference on Artificial Intelligence (**ECAI 2025**). (July. 2025)
- Our paper 'MedLeak: Harvesting Multimodal Medical Data in Secure Federated Learning with Crafted Models' was accepted by the IEEE/ACM Conference on Connected Health: Applications, Systems, and Engineering Technologies 2025 (**CHASE 2025**). (Feb. 2025)
- Our paper 'FeCo: Boosting Intrusion Detection Capability in IoT Networks via Contrastive Learning' was accepted by IEEE Transactions on Dependable and Secure Computing (**TDSC 2025**). (Feb. 2025)
- Our paper 'StarCast: A Secure and Spectrum-Efficient Group Communication Scheme for LEO Satellite Networks' was accepted by the IEEE International Symposium on Dynamic Spectrum Access Networks 2025 (**DySPAN 2025**). (Feb. 2025)
- Our paper 'Scale-MIA: A Scalable Model Inversion Attack against Secure Federated Learning via Latent Space Reconstruction' was accepted by the Network and Distributed System Security Symposium 2025 (**NDSS 2025**). (Nov. 2024)
